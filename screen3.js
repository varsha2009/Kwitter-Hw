var firebaseConfig = {
 ...
 var n = "<div id='h4' style='background-color: pink'><div><h4 class='message_h4'>&nbsp&nbsp;"+name+"<img src='user_icon.png' class='user_icon_class'><br><br>&nbsp&nbsp;"+message+"</h4></div></div>";
